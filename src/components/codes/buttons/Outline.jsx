...
export default function Code(props){
	...
	return (
		<div ref={codeBlock}>
{`<button 
  className="btn bg-opacity-20 hover:bg-opacity-100 
             dark:bg-opacity-20 dark:hover:bg-opacity-100">
  Default
</button>

<button 
  className="btn bg-primary border-primary text-primary bg-opacity-10 hover:bg-primary hover:text-white 
             dark:bg-primary dark:border-primary dark:text-primary dark:bg-opacity-10 dark:hover:bg-primary dark:hover:text-white">
  Primary
</button>

<button 
  className="btn bg-secondary border-secondary text-secondary bg-opacity-10 hover:bg-secondary hover:text-white 
...
<button 
  className="btn bg-alt border-alt text-alt bg-opacity-10 hover:bg-alt hover:text-white 
