export default function Code(props){
	...
	<>
		...
		<code className={class_list}>{`"w-full h-72 overflow-x-auto scrollbar scrollbar-thumb-slate-400 scrollbar-track-slate-100"`}</code>
		<code className={mark}>{`>`}</code>
		<br/>
		<code className={mark}>{`  <`}</code>
		...
		<code className={class_name}> {`class`}</code>
		<code className={equal}>{`=`}</code>
		<code className={class_list}>{`"table"`}</code>
		<code className={mark}>{`>`}</code>
		<br/>
