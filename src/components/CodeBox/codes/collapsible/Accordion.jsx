...
export const Code_CollapsibleAccordion = () => {
...
{`<div class="grid gap-6 mt-6 md:grid-cols-2">
  <div class="grid content-start gap-4">
    <div>
      <div class="collapsible">
        <input type="radio" name="collapseOnebyOne" id="tab1">
    ...
    <div>
      <div class="collapsible">
        <input type="radio" name="collapseOnebyOne" id="tab2">
    ...
    <div>
      <div class="collapsible">
        <input type="radio" name="collapseOnebyOne" id="tab3>
  ...
  <div class="grid content-start gap-4">
    <div>
      <div class="collapsible">
        <input type="radio" name="collapseOnebyOne" id="tab4">
    ...
    <div>
      <div class="collapsible">
        <input id="tab5" type="radio" name="collapseOnebyOne">
    ...
    <div>
      <div class="collapsible">
        <input id="tab6" type="radio" name="collapseOnebyOne">
